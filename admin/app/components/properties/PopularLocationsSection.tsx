...
export default function PopularLocationsSection({
  ...
  return (
    <section className="overflow-hidden rounded-[2rem] border border-[var(--admin-border)] bg-card shadow-[0_24px_70px_-56px_var(--admin-shadow)]">
      <div className="border-b border-[var(--admin-border)] bg-[linear-gradient(135deg,var(--admin-primary-soft),var(--admin-background),var(--admin-secondary-soft))] px-5 py-5 sm:px-6 sm:py-6">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <span className="inline-flex items-center gap-2 rounded-full border border-[var(--admin-border)] bg-[color:color-mix(in_srgb,var(--admin-card)_85%,transparent)] px-3 py-1.5 text-[10px] font-black uppercase text-[var(--admin-primary)] shadow-sm">
          ...
          <div className="inline-flex w-fit items-center gap-2 rounded-full border border-[var(--admin-border)] bg-card px-4 py-2 text-xs font-bold text-[var(--admin-muted)] shadow-sm">
        ...
        {items.map((item) => (
          ...
          >
            <div className="flex items-start justify-between gap-3">
              ...
              <span className="inline-flex h-8 min-w-8 shrink-0 items-center justify-center rounded-full bg-card px-2 text-xs font-black text-[var(--admin-primary)] shadow-sm">
                {item.count}
              </span>
            </div>
