...
export default function ReportListingButton({
  ...
  return (
    <>
      ...
      {open ? (
        <div
          className="fixed inset-0 z-[90] flex items-end justify-center bg-slate-950/55 px-4 py-4 backdrop-blur-sm sm:items-center sm:py-6"
        >
          <button
            type="button"
          ...
          <div
            ...
            className="relative z-10 flex max-h-[calc(100dvh-2rem)] w-full max-w-lg flex-col overflow-hidden rounded-[1.5rem] bg-white shadow-[0_30px_90px_-40px_rgba(15,23,42,0.55)] sm:max-h-[calc(100dvh-3rem)]"
          >
            <div className="flex shrink-0 items-start justify-between gap-4 border-b border-[var(--admin-border)] bg-white px-5 py-4">
              <div>
                <h2
              ...
              <button
                type="button"
                onClick={closeModal}
                className="inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-[var(--admin-border)] bg-white text-[var(--admin-muted)] shadow-sm transition hover:border-[var(--admin-danger)] hover:text-[var(--admin-danger)]"
                aria-label="Close report form"
              >
                <X className="h-5 w-5" />
              </button>
            ...
            {!successMessage ? (
              <div className="shrink-0 border-t border-[var(--admin-border)] bg-white px-5 py-4">
                <button
                  type="button"
