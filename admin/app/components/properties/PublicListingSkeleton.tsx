export default function PublicListingSkeleton() {
  return (
    <main className="flex min-h-screen flex-1 flex-col bg-[var(--admin-background)]">
      <section className="mx-auto flex min-h-screen w-full max-w-7xl items-center justify-center px-4 py-16 sm:px-6 lg:px-8">
