      ...
      <section className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 lg:py-8">
        ...
        <div className="mt-7 grid items-start gap-6 xl:grid-cols-[minmax(0,1fr)_340px]">
          ...
          <aside className="space-y-5 xl:sticky xl:top-[90px] xl:self-start">
            <section className="overflow-hidden rounded-[1.75rem] border border-[var(--admin-border)] bg-white shadow-[0_24px_60px_-35px_rgba(15,23,42,0.3)]">
              ...
              <div className="space-y-3 p-5">
                ...
                <p className="rounded-2xl border border-amber-200 bg-amber-50 px-4 py-3 text-xs font-bold leading-5 text-amber-800">
                  ...
                  the property and the person you are dealing with. AnganStay is
                  not responsible for payments or agreements made directly
                  between users.
                </p>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-2 text-sm font-medium leading-6 text-[var(--admin-muted)]">
                      ...
                      not guarantee ownership, legal title, property condition,
                      availability, or transaction safety.
                    </p>
                  </div>
                </div>
            ...
            <section className="rounded-[1.75rem] border border-[var(--admin-border)] bg-white p-5 shadow-sm">
              <div className="flex items-start gap-3">
                <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl bg-[var(--admin-danger-soft)] text-[var(--admin-danger)]">
                  <Flag size={17} />
                </span>

                <div>
                  <h2 className="text-lg font-black tracking-tight text-[var(--admin-text)]">
                    Something wrong?
                  </h2>

                  <p className="mt-1 text-sm font-medium leading-6 text-[var(--admin-muted)]">
                    Report fake, misleading, unavailable, or suspicious
                    listings.
                  </p>
                </div>
              </div>
