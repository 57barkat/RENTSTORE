      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Choose which rent plans you want to offer for this {propertyLabel}
              , then enter the amount for each enabled option.
            </Text>
          ...
          >
            ...
            <Text
              style={[styles.sectionSubtitle, { color: currentTheme.muted }]}
            >
              Select which utility bills are already included in the rent
              amount.
            </Text>
